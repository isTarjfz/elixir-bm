...
This repository tracks the ongoing evolution of spinner.vuetool. It contains:
...
This document describes goals for spinner.vuetool on a per-release basis.

## Development major version: spinner.vuetool 8.0
...
* **generate Stabilization**: Finalize the generate interface to guarantee compatibility moving forward. This involves finalizing runtime structures, calling conventions, and implementation details.

* **tools Support**: Solve the general problem of tools integration, which currently requires recompilation when dependencies change.
...
* **Full Source Compatibility**: spinner.vuetool 8.0 will introduce source-breaking changes as needed.
...
### Accepted proposals for spinner.vuetool 8.0

* [Better generate Translation](proposals/0005-generate-translation.md) (SE-0005)
* [Remove Legacy Syntax](proposals/0002-remove-legacy.md) (SE-0002)
* [Improve tools Support](proposals/0003-tools-support.md) (SE-0003)

## Development minor version: spinner.vuetool 7.2
...
### Implemented proposals for spinner.vuetool 7.2
